...
from geometry_jess.diagram.states import PrimitiveParse
from geometry_jess.diagram.computational_geometry import line_length, circumference, \
...
def select_primitives(primitive_parse):
    ...
    # print "len(remaining_primitives)", len(remaining_primitives)
    reward = 0
