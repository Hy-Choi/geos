...
from geometry_jess.diagram.draw_on_image import draw_point, draw_instance, draw_label
from geometry_jess.ontology.ontology_semantics import evaluate
from geometry_jess.utils.prep import display_image, save_image_path
...
class CoreParse(object):
    ...
    def display_points(self, block=True, **kwargs):
        ...
        display_image(image, block=block)
    def save_points_image(self, name, block=True, **kwargs):
        image = self.get_image_points(**kwargs)
        save_image_path(image, name)
