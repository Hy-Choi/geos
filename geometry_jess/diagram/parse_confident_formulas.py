...
from geometry_jess.ontology.ontology_definitions import FormulaNode, signatures, FunctionSignature
...
def parse_confident_formulas(graph_parse):
    ...
    for from_key, to_key, data in line_graph.edges(data=True):
        ...
        # print "var", line_variable
        points = data['points']
        line_dict.append(line_variable.children)
