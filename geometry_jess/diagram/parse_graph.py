...
import itertools
from geometry_jess.diagram.computational_geometry import distance_between_line_and_point, \
    distance_between_circle_and_point, distance_between_arc_and_point
from geometry_jess.diagram.instance_exists import instance_exists
from geometry_jess.diagram.states import CoreParse, GraphParse
from geometry_jess.ontology.instantiator_definitions import instantiators
from geometry_jess.parameters import LINE_EPS, CIRCLE_EPS
from geometry_jess.ontology.ontology_definitions import FormulaNode, signatures
...
def _get_arc_graph(core_parse, circle, circle_variable, circle_points):
    ...
    # print arc_graph.edges()
    # print arc_graph.edge
    return arc_graph
